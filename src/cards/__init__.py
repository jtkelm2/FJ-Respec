...
from cards.roles import (
    role_card, food_fighter, corruption, the_poet,
    the_world_role, leo, detective,
)
from cards.majors import (
    the_fool, the_empress, the_emperor, strength, the_lovers, the_hermit,
    the_wheel_of_fortune, justice, the_hanged_man,
    the_magician, the_high_priestess, the_chariot, death_card, the_tower,
    temperance, the_star, the_moon, judgement, the_world,
)
